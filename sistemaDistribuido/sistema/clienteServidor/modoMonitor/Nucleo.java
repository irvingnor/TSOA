...
public class Nucleo{
	...
	public static void agregaTablaEmision(ParMaquinaProceso asa)
	{
		nucleo.insertaTablaEmision(asa);
	}
	
	public static void dameBuzon(int idProcesoServidor)
	{
		nucleo.dameBuzon(idProcesoServidor);
	}
