	...
	class ManejadorSolicitud implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			if (com.equals("Solicitar")){
				...
				if (com=="Crear"){
					ProcesoCliente.setCodop((short) 1);
				}
				if (com=="Eliminar"){
					ProcesoCliente.setCodop((short) 2);
				}
				if (com=="Leer"){
					ProcesoCliente.setCodop((short) 3);
				}
				if (com=="Escribir"){
					ProcesoCliente.setCodop((short) 4);
				}
				imprimeln("\nSolicitud a enviar: "+com);
				imprimeln("\nMensaje a enviar: "+campoMensaje.getText());
				String mensaje = campoMensaje.getText();
				ProcesoCliente.setMensaje(mensaje);
